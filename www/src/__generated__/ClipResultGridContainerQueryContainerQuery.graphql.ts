/**
 * @generated SignedSource<<a11d776b61ccbd450af57dd54b762baa>>
...
export type ClipResultGridContainerQueryContainerQuery$data = {
  readonly clips: {
    readonly " $fragmentSpreads": FragmentRefs<"ClipResultGridContainer_clip">;
  };
};
export type ClipResultGridContainerQueryContainerQuery = {
  response: ClipResultGridContainerQueryContainerQuery$data;
  variables: ClipResultGridContainerQueryContainerQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "4b1d964f66816ee363b426fe3a42f7b4",
    "id": null,
    "metadata": {},
    "name": "ClipResultGridContainerQueryContainerQuery",
    "operationKind": "query",
...
(node as any).hash = "17b96550106090a2bc4661467c5c15fa";
