...
func (m *EntClipMetadataMutation) SetThumbnail(s string) {
	m.thumbnail = &s
}

// Thumbnail returns the value of the "thumbnail" field in the mutation.
func (m *EntClipMetadataMutation) Thumbnail() (r string, exists bool) {
	v := m.thumbnail
	if v == nil {
		return
	}
...
// OldThumbnail returns the old "thumbnail" field's value of the EntClipMetadata entity.
// If the EntClipMetadata object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *EntClipMetadataMutation) OldThumbnail(ctx context.Context) (v *string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *EntClipMetadataMutation) ResetThumbnail() {
	m.thumbnail = nil
}
...
func (m *EntClipMetadataMutation) Fields() []string {
	...
	if m.thumbnail != nil {
		fields = append(fields, entclipmetadata.FieldThumbnail)
	}
	return fields
}
